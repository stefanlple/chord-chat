struct ChatModel: WebSocketListener {
    ...
    public mutating func send() {
        var sendCommand: any TextCommand = SendCommand(
            senderName: senderName, messageFactory: messageFactory)
    ...
    static func == (lhs: ChatModel, rhs: ChatModel) -> Bool {
        return lhs.webSocketUrl == rhs.webSocketUrl && lhs.senderName == rhs.senderName
    }
}
